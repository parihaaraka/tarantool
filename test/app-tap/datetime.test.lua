...
local only_integer_ival = 'only integer values allowed in interval '..
                        'seconds if nsec, usec, or msecs provided'
...
test:test("Time interval __index fields", function(test)
    ...
    test:is(tostring(ival), '+12345 years, +123 months, +747 days, 0 hours,'..
            ' 3 minutes, 1 seconds, 12345678 nanoseconds', '__tostring')
...
test:test("Time interval operations", function(test)
    ...
    local leap_ivals_check = {
        {{month = 1}, '1972-03-31T00:00:00Z', '1972-01-31T00:00:00Z'},
        {{month = 1}, '1972-04-30T00:00:00Z', '1971-12-31T00:00:00Z'},
        {{month = 5}, '1972-09-30T00:00:00Z', '1971-07-31T00:00:00Z'},
        {{year = 1, month = 2}, '1973-12-01T00:00:00Z', '1970-05-31T00:00:00Z'},
        {{year = 2, month = 3}, '1976-03-01T00:00:00Z', '1968-02-29T00:00:00Z'},
        {{month = 1}, '1976-04-01T00:00:00Z', '1968-01-31T00:00:00Z'},
        {{month = 1}, '1976-05-01T00:00:00Z', '1967-12-31T00:00:00Z'},
        {{month = 5}, '1976-10-01T00:00:00Z', '1967-07-31T00:00:00Z'},
        {{year = -1}, '1975-10-02T00:00:00Z', '1968-07-30T00:00:00Z'},
        {{year = -1}, '1974-10-02T00:00:00Z', '1969-07-31T00:00:00Z'},
    }
...
test:test("Time interval operations - different adjustments", function(test)
    ...
    local leap_ivals_check_add = {
        ...
        {{year = 1, month = 2}, {'1973-12-01T00:00:00Z', '1973-11-30T00:00:00Z',
                                 '1973-11-30T00:00:00Z'}},
        {{year = 2, month = 3}, {'1976-03-01T00:00:00Z', '1976-02-29T00:00:00Z',
                                 '1976-03-01T00:00:00Z'}},
        {{month = 1}, {'1976-04-01T00:00:00Z', '1976-03-29T00:00:00Z',
                       '1976-04-01T00:00:00Z'}},
        {{month = 1}, {'1976-05-01T00:00:00Z', '1976-04-29T00:00:00Z',
                       '1976-05-01T00:00:00Z'}},
        {{month = 5}, {'1976-10-01T00:00:00Z', '1976-09-29T00:00:00Z',
                       '1976-10-01T00:00:00Z'}},
        {{year = -1}, {'1975-10-02T00:00:00Z', '1975-09-30T00:00:00Z',
                       '1975-10-02T00:00:00Z'}},
        {{year = -1}, {'1974-10-02T00:00:00Z', '1974-09-30T00:00:00Z',
                       '1974-10-02T00:00:00Z'}},
    }
    ...
    for _, row in pairs(leap_ivals_check_add) do
        ...
        for i=1,3 do
            ...
            local sadd = sadds[i]
            test:is(tostring(tadd[i]:add(delta, {adjust=adjust})), sadd,
                    ('add delta to %s with adjust %s'):format(sadd, adjust))
    ...
    local leap_ivals_check_sub = {
        ...
        {{year = 2, month = 3}, {'1968-02-29T00:00:00Z', '1968-02-28T00:00:00Z',
                       '1968-02-28T00:00:00Z'}},
        {{month = 1}, {'1968-01-31T00:00:00Z', '1968-01-28T00:00:00Z',
                       '1968-01-28T00:00:00Z'}},
        {{month = 1}, {'1967-12-31T00:00:00Z', '1967-12-28T00:00:00Z',
                       '1967-12-28T00:00:00Z'}},
        {{month = 5}, {'1967-07-31T00:00:00Z', '1967-07-28T00:00:00Z',
                       '1967-07-28T00:00:00Z'}},
        {{year = -1}, {'1968-07-30T00:00:00Z', '1968-07-27T00:00:00Z',
                       '1968-07-27T00:00:00Z'}},
        {{year = -1}, {'1969-07-31T00:00:00Z', '1969-07-28T00:00:00Z',
    ...
    for _, row in pairs(leap_ivals_check_sub) do
        ...
        for i=1,3 do
            local adjust = adj_modes[i]
            local ssub = ssubs[i]
            test:is(tostring(tsub[i]:sub(delta, {adjust=adjust})), ssub,
                    ('sub delta to %s with adjust %s'):format(ssub, adjust))
        end
    end
end)
...
test:test("Time intervals creation - range checks", function(test)
    ...
    local specific_errors = {
        ...
        {only_one_of, { usec = 123, msec = 123}},
        {only_one_of, { nsec = 123456, usec = 123, msec = 123}},
        {only_integer_ival, { sec = 12345.125, usec = 123}},
        {only_integer_ival, { sec = 12345.125, msec = 123}},
        {only_integer_ival, { sec = 12345.125, nsec = 123}},
