...
_ = t1:upgrade("notest", "upgrade_func", new_format, true)
_ = t2:upgrade("test", "upgrade_func", new_format, true)
_ = t3:upgrade("notest", "error_func", new_format, true)
_ = t4:upgrade("notest", "error_delayed_func", new_format, true)
...
new_format = {{name="x", type="unsigned"}, {name="y", type="string"}}
t3:upgrade("notest", "upgrade_func", new_format)
t4:upgrade("notest", "upgrade_func", new_format)
